object frmCursos: TfrmCursos
  ...
  object conn: TADOConnection
    Connected = True
    ConnectionString = 
      'Provider=Microsoft.Jet.OLEDB.4.0;Data Source=C:\Users\etec\Docum' +
      'ents\GitHub\Delphi-Projects\Cursos\Banco.mdb;Persist Security In' +
      'fo=False'
    LoginPrompt = False
  ...
  object cursos: TADODataSet
    ...
    Left = 312
    Top = 112
    object cursosCódigo: TAutoIncField
      FieldName = 'C'#243'digo'
      ReadOnly = True
    end
    object cursosNome: TWideStringField
      FieldName = 'Nome'
      Size = 255
    end
  end
