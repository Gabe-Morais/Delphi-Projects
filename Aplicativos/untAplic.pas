...
begin
    WinExec('C:\Program Files\Windows NT\Accessories\wordpad.exe', SW_SHOWNORMAL);
end;
...
procedure TfrmAplic.PowerPoint1Click(Sender: TObject);
begin
    WinExec('C:\Program Files\Microsoft Office\Office16\POWERPNT.EXE', SW_SHOWNORMAL);
end;
